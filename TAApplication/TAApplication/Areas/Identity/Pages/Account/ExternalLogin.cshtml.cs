    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.Name = info.Principal.Claims.FirstOrDefault(c => c.Type == ClaimTypes.GivenName).Value
                        + " " + info.Principal.Claims.FirstOrDefault(c => c.Type == ClaimTypes.Surname).Value;

                Input.Email = info.Principal.Claims.FirstOrDefault(c => c.Type == ClaimTypes.Email).Value;
